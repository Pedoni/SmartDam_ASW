...
\subsection{Frontend}
Riguardo alla parte frontend, abbiamo preferito concentrare i nostri sforzi sul massimizzare l'accessibilità. Il tool che abbiamo scelto per verificare tale metrica è \lighthouse, integrato dentro la sezione DevTools di Google Chrome.
